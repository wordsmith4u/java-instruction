...
public class FutureValueApp {
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			...
			// Process a rectangular array as strings for futureValue
		...
		// Create Nested ForLoop to display output (outside of existing While loop)
		System.out.println("Inv/Mo.\tRate\tYears\tFuture Value");

		for (int curRow = 0; curRow < rowCounter; curRow++) {
			for (int curCol = 0; curCol < futureValues[curCol].length; ++curCol) {
